...
# To Do: Inference for different model architectures (HostImageryClimateModel, HostImageryOnlyModel, HostClimateOnlyModel)
...
def main():
    ...
    checkpoint_path = r"D:\Ailanthus_NAIP_Classification\NAIP_Host_Model\outputs\ailanthus_naip_climate_dem_ghm_lat_lon_30ep_july1725\checkpoints\checkpoint_epoch_29.tar"
    ...
    # Inference points
    inference_points_df = pd.read_csv(r"D:\Ailanthus_NAIP_Classification\model_inference\inference_points_tiny_debug.csv")
    ...
    results_df.to_csv("model_inference/inference_points_tiny_debug_results.csv", index=False)
